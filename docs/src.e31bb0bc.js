...
module.exports = {
  ...
  "fact": [{
    "dims": {
      ...
      "CASE_DEFINITION": "Confirmed and probable case total",
      "SEX": "Male",
      "AGEGROUP": "All ages (total)"
    },
    "Value": "1017"
  }, {
    "dims": {
    ...
    "Comments": "Total for Liberia, Sierra Leone, and Guinea where sex is known but age may not be known. Cases per capita are available in the WHO external situation report.",
    "Value": "6667"
  }, {
    "dims": {
      "COUNTRY": "All countries",
    ...
    "Comments": "Total for Liberia, Sierra Leone, and Guinea where age is known but sex may not be known. Cases per capita are available in the WHO external situation report.",
    "Value": "2434"
  }, {
    "dims": {
      "COUNTRY": "All countries",
...
},{}],"../data/may-2015.json":[function(require,module,exports) {
module.exports = {
  "dimension": [{
    "label": "COUNTRY",
    "display": "Country"
...
},{}],"../data/apr-2016.json":[function(require,module,exports) {
module.exports = {
  "dimension": [{
    "label": "COUNTRY",
    "display": "Country"
...
var dec2014Data = require('../data/dec-2014.json');

var may2015Data = require('../data/may-2015.json');

var apr2016Data = require('../data/apr-2016.json');

var genderColors = ["#4682b4", "#db7093"];
var ageColors = ["#9e6ebd", "#7aa457", "#cb6751"];
var countryColors = ["#ffa600", "#bc5090", "#374c80"];
var CIRCLE_NUM = 100;
var parsedData2014 = drawNewData(dec2014Data, "dec-2014");
var parsedData2015 = drawNewData(may2015Data, "may-2015");
var parsedData2016 = drawNewData(apr2016Data, "apr-2016");
listeners();
...
function drawCircles(totalPeople, classname) {
  ...
  var date = d3.select(".visual").append("div").text(classname.toUpperCase().replace('-', ' ')).attr("class", "date");
  var svgContainer = d3.select(".visual").append("svg").attr("width", 700).attr("height", totalPeople / 2300 * 36);
  var xCoord = 20;
  var yCoord = 20;
...
function colorLegend(filterType) {
  ...
  for (var i = 0; i < legendLabels.length; i++) {
    var circle = svgContainer.append("circle").attr("cx", xCoord).attr("cy", yCoord).attr("r", 8).style("fill", circleColors[i]);
    var label = svgContainer.append("text").text(legendLabels[i]).attr("x", xCoord + 15).attr("y", yCoord + 5).style("font-family", "Lato");
    yCoord += 30;
  }
}
...
function listeners() {
  d3.select("#gender").on("click", function () {
    ...
    d3.selectAll("input").each(function (d) {
      if (d3.select(this).attr("type") == "checkbox") d3.select(this).node().checked = true;
    });
...
},{"d3":"../node_modules/d3/index.js","../data/dec-2014.json":"../data/dec-2014.json","../data/may-2015.json":"../data/may-2015.json","../data/apr-2016.json":"../data/apr-2016.json"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
